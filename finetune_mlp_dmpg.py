...
from utils.cal import frozen_model_backbone
...
def main(args):
    ...
    plt.ylabel('error')
    plt.legend()
    plt.savefig(osp.join(config['calibrate']['save']['save_path'], f'calibrate_result_{sample_num}_{sample_point_num}_{sample_method}.jpg'))
